...
stations_uic = set()
with open("./data/gare.json", "r") as file:
...
line_codes = set()
station_list = []
with open("./data/liste-des-gares.json") as file:
    loaded_file = json.load(file)
...
with open("./data/formatted-list-of-stations.json", "w") as file:
    json.dump(station_list, file)


# circuits/lines
data = []
with open("./data/circuits-list.json", "r") as file:
    loaded_file = json.load(file)
...
with open("./data/circuits-list2.json", "w") as file:
    json.dump(data, file)
